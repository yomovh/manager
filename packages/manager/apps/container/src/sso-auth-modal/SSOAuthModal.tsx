...
const SSOAuthModal = (): JSX.Element => {
  ...
  const DisconnectedButton = ({ label }: { label: string }) => (
    <OsdsButton
      slot="actions"
    ...
    <>
      {show && (
        <OsdsModal onOdsModalClose={() => setMode('')}>
          <div>
            ...
            <div className="row p-3">
              ...
              {(mode === disconnectedToConnected ||
                ...
                >
                  <div className="mb-2">
                    <ModalContent label={t('sso_modal_currentuser_title')} />
                  </div>
                  <OsdsTile>
                    <span
                      slot="start"
          ...
          {mode === connectedToDisconnected && (
            <DisconnectedButton label={t('sso_modal_action_logout')} />
          )}
